...
export default class ProfileDetail extends Component {
    ...
    EditProjectButton = () => {
        ...
        if (this.state.image) {
            axios.put('http://192.168.1.101/partner_project_backend/new_partner_photo.php',
                {
                    ...
                    activity_year: this.state.activity_year,
            ...
            axios.put('http://192.168.1.101/partner_project_backend/new_partner.php',
                {
                    username: this.props.route.params.username,
                    title: this.state.title,
                    detail: this.state.detail,
                    ...
                    <Post post={post} />
                        ...
                        <View style={styles.postView} >
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    <Text style={{ marginBottom: 10 }} >Yıllık Kazanç</Text>
                                    <DropDownPicker
                                ...
                                <View style={{ marginTop: 10 }}>
                                    <Text>Faaliyet Yılı/Yılları</Text>
                                    <TextInput
                                        ...
                                        multiline={true}
                                        numberOfLines={50}
                                        onChangeText={activity_year => this.setState({ activity_year: activity_year })}
