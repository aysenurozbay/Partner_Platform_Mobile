...
export default class ProfileDetail extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            project: {
                ...
                name: this.props.route.params.project[0].name,
                details: this.props.route.params.project[0].details,
                ...
                amount: this.props.route.params.project[0].amount,
    ...
    // componentDidMount(){
    //   console.log('====================================');
    //   console.log(this.props.route.params.project[0].id);
    //   console.log('====================================');
    // }
    ...
    EditProjectButton = () => {
        ...
        if (this.state.image) {
            axios.put('http://192.168.1.101/partner_project_backend/project_edit_photo.php',
                {
            ...
            axios.put('http://192.168.1.101/partner_project_backend/project_edit.php',
                {
                    id: this.state.project.id,
                    name: this.state.project.name,
                    details: this.state.project.details,
