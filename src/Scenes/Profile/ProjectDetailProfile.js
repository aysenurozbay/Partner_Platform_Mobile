...
export default class ProjectDetailProfile extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    axios.post('http://192.168.1.101/partner_project_backend/project_detail.php',
    {
  ...
  DeletePartnerButton = () => {
    ...
    //   {cancelable: false},
    // );
    axios.post('http://192.168.1.101/partner_project_backend/delete_project.php',
      {
        ...
        <SafeAreaView>
              ...
              <View style={styles.postsView} >
                ...
                <View style={styles.postView} >
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      { this.props.navigation.navigate('ProjectEdit', { project: this.state.project}) }
                    }}
